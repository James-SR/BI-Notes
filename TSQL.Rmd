...
* [Adventure Works db install script](../files/TSQL/AW-oltp-install-script)  
NOTE: Remember to ensure read only access for everyone to the folder containing the .SQL and other files
* [GitHib Repo for course including course materials, slides, labs etc](https://microsoftlearning.github.io/QueryingT-SQL/)
...
```{r Pivot Answer, echo = FALSE, fig.cap='Pivot Answer Section 4 Question 5'}
knitr::include_graphics("images/TSQL/PivotAnswerS4Q5.png")
```
