...
Next we usually want to answer some quesiton with our data, like "What is the probability that a person in excellent health suffers from depression?" and "Are depression rates lower for healthier people?" which we do so by creating conditional probabilities.
